      ...
      <div className="flex-[3] flex flex-col bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div className="p-4 border-b border-slate-100 bg-white z-10">
          <div className="relative">
            ...
            <input 
              autoFocus
              className="w-full pl-12 pr-4 h-12 bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-emerald-500 transition-colors text-lg" 
        ...
        <div className="bg-white border-b border-slate-200 p-4 space-y-3">
                 ...
                 <div className="text-right">
                    {user?.role === 'admin' && !user.branchId ? (
                       <div className="w-40 ml-auto">
                          ...
                          <select 
                            className="w-full text-xs font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded p-1 outline-none focus:border-emerald-500"
                       ...
                       <>
                         ...
                         <p className="text-xs font-mono font-bold text-emerald-600">POS-01</p>
                       </>
                    )}
                </div>
             </div>
             ...
             <div className="grid grid-cols-2 gap-3">
                 <div>
                    ...
                    <select 
                        className="w-full text-sm font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded p-1.5 outline-none focus:border-emerald-500"
                        value={salesmanId}
                 ...
                 <div ref={dropdownRef} className="relative">
                    ...
                    {showCustomerDropdown && (
                        <div className="absolute top-full left-0 right-0 z-30 bg-white border border-slate-200 mt-1 rounded-lg shadow-xl p-2">
                            <input 
                                autoFocus
                                className="w-full p-2 text-sm border border-slate-200 rounded mb-2 outline-none focus:border-emerald-500"
                            ...
                            />
                             <div className="max-h-40 overflow-y-auto space-y-1">
                                ...
                                {customers.filter(c => c.name.toLowerCase().includes(customerSearch.toLowerCase())).map(c => (
                                    <div key={c.id} className="p-2 hover:bg-emerald-50 rounded cursor-pointer text-sm font-semibold text-slate-700"
                             ...
                             <button onClick={() => { setShowCustomerModal(true); setShowCustomerDropdown(false); }} className="w-full mt-2 py-2 bg-emerald-50 text-emerald-600 text-xs font-bold rounded hover:bg-emerald-100 flex items-center justify-center gap-1">
                                <FiPlus /> New Customer
                             </button>
                        </div>
                    )}
                            ...
                            <div className="flex items-center text-sm">
                                ...
                                <div className="flex-[3] pr-2">
                                    ...
                                    <div className="flex items-center gap-1 mt-1">
                                        <div className="flex items-center gap-0.5">
                                            <input 
                                                className="w-8 p-0.5 text-[10px] text-center bg-slate-100 border border-slate-200 rounded outline-none focus:border-emerald-500"
                                                placeholder="%"
                                        ...
                                        <div className="flex items-center gap-0.5">
                                            ...
                                            <input 
                                                className="w-10 p-0.5 text-[10px] text-center bg-slate-100 border border-slate-200 rounded outline-none focus:border-emerald-500"
                                                placeholder="Amt"
                                ...
                                <div className="flex-[2] flex justify-center">
                                    <div className="flex items-center border border-slate-200 rounded bg-white">
                                        <button className="w-6 h-6 flex items-center justify-center text-slate-400 hover:text-emerald-600 hover:bg-emerald-50" onClick={() => updateQuantity(item.id, item.quantity - 1)}>-</button>
                                        <input 
        ...
        <div className="bg-slate-50 border-t border-slate-200 p-4 space-y-3">
             <div className="space-y-1 text-sm">
                ...
                {customerBalance !== 0 && (
                 ...
                 <div className="flex justify-between items-center text-slate-500">
                    ...
                    <input 
                        className="w-20 text-right bg-transparent border-b border-dashed border-slate-300 outline-none focus:border-emerald-500 font-mono"
                        value={roundOff}
             ...
             <div className="flex justify-between items-end pt-2 border-t border-slate-200">
                 ...
                 <div className="relative">
                    ...
                    <input 
                        className="w-40 text-right text-3xl font-black text-slate-800 bg-transparent border-b-2 border-transparent hover:border-slate-200 focus:border-emerald-500 outline-none transition-all pl-6"
             ...
             <button 
                ...
                className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 text-white rounded-xl shadow-lg shadow-emerald-200 disabled:shadow-none font-bold text-lg transition-all flex items-center justify-center gap-2"
             >
                 <FiMonitor /> Pay Now
             </button>
        </div>
              ...
              <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="grid grid-cols-5 gap-2">
                             {['Cash', 'Card', 'UPI', 'Credit', 'Sales Return'].map(method => (
                                  <button 
                                    ...
                                    className={`py-2 px-1 rounded-lg text-[10px] font-bold transition-all border whitespace-nowrap ${
                      ...
                      <div className="mb-6">
                           <div className="flex justify-between items-center mb-2">
                               ...
                               <span className={`text-xs font-bold ${
                                   (parseFloat(paymentData.paidAmount || 0) - (total - addedPayments.reduce((s,x)=>s+x.amount,0))) >= 0 
                                   ? 'text-emerald-600' 
                                   : 'text-orange-500'
                               }`}>
                                   {(() => {
                           ...
                           <div className="flex gap-2">
                               <div className="relative flex-1">
                                   ...
                                   <input 
                                     autoFocus
                                     type="number" 
                                     className="w-full pl-8 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 font-bold text-lg text-slate-800 transition-all"
                                     placeholder="0.00"
                               ...
                               <button 
                                   ...
                                   className="px-4 py-3 bg-white border border-slate-200 text-emerald-600 rounded-lg font-bold hover:bg-emerald-50 hover:border-emerald-200 transition-all text-sm whitespace-nowrap"
                  ...
                  <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-3">
                      ...
                      <button 
                        ...
                        className="flex-1 py-3 px-6 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold shadow-lg shadow-emerald-200 transition-all flex items-center justify-center gap-2 text-sm"
                      >
                          <FiMonitor size={16} />
                           ...
                           <table className="w-full text-sm text-left">
                               ...
                               <tbody>
                                   {salesHistory.map(sale => (
                                       <tr key={sale.id} className={`border-b hover:bg-slate-50 cursor-pointer ${selectedHistorySale?.id === sale.id ? 'bg-emerald-50' : ''}`} onClick={() => setSelectedHistorySale(sale)}>
                                           <td className="p-3">
                                           ...
                                           <td className="p-3 text-emerald-600"><FiMonitor /></td>
                                       </tr>
                                   ))}
                               </tbody>
                           </table>
                           ...
                           <div className="flex-1 bg-slate-50/50 p-6 overflow-y-auto">
                               <div className="bg-white p-6 rounded-xl shadow-sm border">
                                    <div className="flex justify-between items-start mb-6 border-b pb-4">
                                        ...
                                        <div className="text-right">
                                            <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase ${selectedHistorySale.isReturn ? 'bg-red-100 text-red-700' : 'bg-emerald-100 text-emerald-700'}`}>
