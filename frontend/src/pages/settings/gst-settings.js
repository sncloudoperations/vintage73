      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-emerald-50 rounded-xl border border-emerald-100 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold text-emerald-800 uppercase tracking-wider text-xs">Global API Integration (Bot Mode)</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-[10px] font-medium text-emerald-700 mb-1 uppercase tracking-widest">GSP Provider Name</label>
              <select
                name="gspName"
            ...
            <div>
              <label className="block text-[10px] font-medium text-emerald-700 mb-1 uppercase tracking-widest">API Environment Mode</label>
              <div className="flex bg-white p-1 rounded-lg border border-emerald-200">
                ...
                <button
                  ...
                  className={`flex-1 py-1.5 text-xs font-medium rounded-md transition-all ${settings.apiMode === 'PRODUCTION' ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-500 hover:bg-slate-50'}`}
                >
                  PRODUCTION (Live)
                </button>
              </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="autoEinvoice" className="text-xs font-medium text-slate-600">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="autoEway" className="text-xs font-medium text-slate-600">
                    Enable Auto-Generation
                </label>
            </div>
          </div>
        ...
        <div className="fixed bottom-6 right-6 z-10 shadow-2xl rounded-lg overflow-hidden">
          <button
            type="submit"
            disabled={saving}
            className="btn bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 font-medium flex items-center gap-2 shadow-xl active:scale-95 transition-all disabled:opacity-50"
          >
            <FiSave size={18} />
