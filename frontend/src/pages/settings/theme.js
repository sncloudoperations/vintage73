                    ...
                    {colorPresets.map((preset) => (
                        <button
                            ...
                            className={`p-3 rounded-lg border text-left transition-all flex items-center gap-3
                                ${localTheme.primaryColor === preset.primary ? 'border-emerald-500 bg-emerald-50 ring-1 ring-emerald-500' : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50'}
                            `}
                        >
                            ...
                            {localTheme.primaryColor === preset.primary && <FiCheck className="ml-auto text-emerald-600" />}
                        </button>
                    ))}
                </div>
            </div>
