    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 max-w-md">
        <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
            <FiClock className="text-emerald-600" /> Today's Attendance
        </h3>
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-sm">
                ...
                <span className={`px-2 py-1 rounded text-xs font-bold ${status ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-500'}`}>
