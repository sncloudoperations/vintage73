            ...
            <tbody>
              {filteredProducts.map((product) => (
                <tr key={product.id}>
                  ...
                  <td>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${product.stock < 10 ? 'bg-red-50 text-red-600 border border-red-100' : 'bg-emerald-50 text-emerald-600 border border-emerald-100'}`}>
                      {product.stock} units
                    </span>
                  </td>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input className="input" placeholder="Electronics" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})} />
              </div>
              ...
              <div className="flex items-center gap-2 pt-6">
                ...
                />
                <label htmlFor="isTaxInclusive" className="text-sm font-medium text-slate-700">Selling Price Includes Tax</label>
              </div>
