...
export default function CashBookReport() {
    ...
    const handleExport = () => {
        ...
        const csvContent = [
            ...
            ...transactions.map(tx => [
                ...
                tx.voucherNumber,
                `"${tx.particulars} - ${tx.narration || ''}"`, // Quote to handle commas
                tx.debit || 0,
                tx.credit || 0,
    ...
    if (loading && !ledgerInfo) return <div className="p-8 text-center text-slate-500">Loading Cash Book...</div>;
        ...
        <div id="printable-report" className="p-8 max-w-[1200px] mx-auto print:p-0 print:max-w-none bg-white min-h-screen">
            ...
            <div className="text-center border-b-2 border-slate-800 pb-4 mb-6">
                ...
                <div className="mt-4 border-t border-slate-300 pt-2 inline-block px-8">
                    <h2 className="text-xl font-semibold text-slate-800 underline decoration-2 underline-offset-4 decoration-slate-400">Cash Book Report</h2>
                ...
                <table className="table-modern w-full border-collapse border border-slate-300 text-sm min-w-[800px]">
                    ...
                    <tbody>
                        ...
                        <tr className="bg-slate-50 font-medium text-slate-700">
                            ...
                            <td className="border border-slate-300 px-3 py-2 text-right">-</td>
                            <td className="border border-slate-300 px-3 py-2 text-right font-medium text-slate-800">
